...
Indices mu,nu,rho,photind,photind1,...,photind10,mu1,...,mu100,dum1,...,dum16,five;
...
*
* Alternative implementation of the Larin:
* g_mu g_5 -> 1/2 (g_mu g_5 - g_5 g_mu) and replace by 4 gammas and epsilon
*
.sort
chainout ga1;
chainout ga2;
id ga1?(Oub) = 1/2*(ga1(mu)-1/2*(ga1(mu,five)-ga1(five,mu)));
id ga1?(Oubc) = 1/2*(ga1(nu)+1/2*(ga1(five,nu)-ga1(nu,five)));
id ga2?(Osu) = 1/2*(ga2(mu)-1/2*(ga2(mu,five)-ga2(five,mu)));
id ga2?(Osuc) = 1/2*(ga2(nu)+1/2*(ga2(five,nu)-ga2(nu,five)));
chainin ga1;
chainin ga2;
...
.sort
repeat;
id ga1(?mu1,five,?mu2,five,?mu3)=i/24*i/24*eps(dum1,dum2,dum3,dum4)*eps(dum5,dum6,dum7,dum8)*ga1(?mu1,dum1,dum2,dum3,dum4,?mu2,dum5,dum6,dum7,dum8,?mu3);
id ga2(?mu1,five,?mu2,five,?mu3)=i/24*i/24*eps(dum9,dum10,dum11,dum12)*eps(dum13,dum14,dum15,dum16)*ga2(?mu1,dum9,dum10,dum11,dum12,?mu2,dum13,dum14,dum15,dum16,?mu3);
endrepeat;

* once
.sort
id ga1(?mu1,five,?mu2)=-a1*i/24*eps(dum1,dum2,dum3,dum4)*ga1(?mu1,dum1,dum2,dum3,dum4,?mu2);
id ga2(?mu1,five,?mu2)=-a1*i/24*eps(dum5,dum6,dum7,dum8)*ga2(?mu1,dum5,dum6,dum7,dum8,?mu2);
